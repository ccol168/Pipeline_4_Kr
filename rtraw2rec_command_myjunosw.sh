...
source /storage/gpfs_data/juno/junofs/users/ccoletta/junosw/setup.sh
...
python $TUTORIALROOT/share/tut_rtraw2calib.py \
      ...
      --output /storage/gpfs_data/juno/junofs/users/ccoletta/Pipeline_4_Kr/root/test_myjunosw.root \
      ...
      --output-stream /Event/CdLpmtCalib_FPGARaw:on \
      --output-stream /Event/CdTrigger:on \
      --output-stream /Event/Oec:on \
      >& /storage/gpfs_data/juno/junofs/users/ccoletta/Pipeline_4_Kr/log/Test_myjunosw.log
